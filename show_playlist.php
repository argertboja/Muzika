...
$playlist_ID = $_POST['clicked_song'];
...
$play = " select name, song_ID, DATE_FORMAT(date_published, '%d.%m.%Y') as receipt_date from playlist_contains natural join song where playlist_ID = $playlist_ID ;";
...
<h2 style="margin-top:10px">Playlist: <?php 

$play = " select playlist_name as name  from playlist where playlist_ID = $playlist_ID ;";
$playlist_result = mysqli_query($conn, $play);
